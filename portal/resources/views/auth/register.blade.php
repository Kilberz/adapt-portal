...
@section('content')
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-white">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <svg class="mx-auto h-8 fill-gray-900 dark:fill-white" viewBox="0 0 3402.00023 1033.61111" version="1.1"
            ...
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register for an account
            </h2>
        </div>
